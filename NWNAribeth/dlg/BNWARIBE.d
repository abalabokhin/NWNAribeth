...
== BCDORN~Heh, and you still proclaim that you are not like I? In time, you will see.~
EXIT
...
== BIMOEN~Aribeth, just make sure that any injuries won't inhibit his spellcasting.~
...
== BIMOEN~You... won't ever do anything to hurt <CHARNAME>, right?~
== BNWARIBE~.....Why would you ask me that?~
== BIMOEN~I'm sorry, I shouldn't have said anything.~
== BNWARIBE~But you did. You can't ask a question like that without an explanation?~
== BIMOEN~But you didn't give me an answer.~
== BNWARIBE~I would never do anything to cause <CHARNAME> any harm. There, I have answered, now it's your turn.~
== BIMOEN~It's just that... you know that <CHARNAME> is a child of Bhaal, right?~
== BNWARIBE~I have been made aware of that.~
== BIMOEN~I don't know if you are aware of how much <CHARNAME> struggles with that. Sometimes, the essence of Bhaal seems to be too much to bear.~
== BIMOEN~Sometimes <CHARNAME> seems torn between accepting the darkness of Bhaal or fighting against it.~
== BIMOEN~I worry that having you around, someone who fell to the temptation of hatred and revenge would.... would.....~
...
== BIMOEN~Yes. <CHARNAME> and I have been together since .....forever and I need to know that you intend no harm, even unintentional.~
== BNWARIBE~I give you my word. I mean no harm to anyone save my enemies. Does that satisfy you?~
== BIMOEN~I'll admit that I'd hoped for more, but I want to believe in you. So, I will. For now.~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("NWImoenAribeth","GLOBAL",1)~THEN BIMOEN Imoen2
~Whatcha' doing?~
DO~SetGlobal("NWImoenAribeth","GLOBAL",2)~
== BNWARIBE~Hmmm? Oh, just sharpening my sword. Why?~
== BIMOEN~No, I meant that tune that I heard you singing to yourself. What was that?~
...
== BIMOEN~You should sing it to me sometime.~
...
== BIMOEN~Who taught you that song?~
== BNWARIBE~My father.~
== BIMOEN~What was he like? Old Puffguts took care of me and was the closest thing to a father that I had.~
...
== BIMOEN~I'm sorry. I didn't mean to make you think about this.~
== BNWARIBE~It's alright. I don't mind. While it is painful, I also find comfort in remembering my family.~
== BIMOEN~Well, don't forget that you aren't alone anymore. You have <CHARNAME> and I now.~
== BNWARIBE~Thank you Imoen. That means a lot to me.
== BIMOEN~No problem. But if you want me to keep quiet about this, you WILL be singing to me sometime.
== BNWARIBE~Are you serious?~
== BIMOEN~*grins mischievously* What's a little blackmail between friends?~
EXIT
...
CHAIN IF~InParty("NWARIBET")
Detect("NWARIBET")
!StateCheck("Sirene",CD_STATE_NOTVALID)
!StateCheck("NWARIBET",CD_STATE_NOTVALID)
CombatCounter(0)
!See([ENEMY])
Global("NWSireneAribeth","GLOBAL",0)~THEN BSIRINE Sirene1
~Aribeth. Are you ok?~
DO~SetGlobal("NWSireneAribeth","GLOBAL",1)~
== BNWARIBE~I am uninjured.~
== BSIRINE~That isn't what I meant.~
== BNWARIBE~I know.~
== BSIRINE~You spent years as a paladin of Tyr, now you have lost that connection. I want you to know that I'm here to help you through this.~
...
== BSIRINE~It matters not if you want my help. What matters is that I am here if you need my help.~
...
== BSIRINE~I can listen to you. I can offer advice. I can be a friend.~
== BNWARIBE~If you really wish to help, then let me be!~
== BSIRINE~Very well. However, I will be here when you are ready.~
EXIT

// 2.
// --
CHAIN IF~InParty("Sirene")
Detect("Sirene")
!StateCheck("Sirene",CD_STATE_NOTVALID)
!StateCheck("NWARIBET",CD_STATE_NOTVALID)
CombatCounter(0)
...
== BSIRINE~Good day to you Aribeth. Can I help you with something?~
...
== BSIRINE~You are too perceptive.~
== BNWARIBE~Explain.~
== BSIRINE~You'd have to be blind to not notice my appearance. My fiendish blood.~
== BNWARIBE~Yes, what of it?~
== BSIRINE~I've always considered myself unworthy of being a paladin, due to my tainted blood.~
== BSIRINE~The evil that is a part of my nature precludes me from becoming the sort of paladin for which I have always strove to be.~
== BSIRINE~But then I met you. A paladin, formerly of the highest rank, now fallen. I wanted to help you, because of what it could mean for me.~
== BNWARIBE~My redemption would then, in a way become yours.~
== BSIRINE~As I said, you are far too perceptive. *Sigh* That is correct.~
== BSIRINE~If I could help redeem you, you who had fallen so far, if you could climb back up from this abyss, then there would be hope for me too.~
...
== BSIRINE~Why does it now feel like I am the one being helped.~
== BNWARIBE~I'm just saying what you needed to hear.~
== BSIRINE~So, I'm a fool are I? Does this mean that we are friends, at least?~
== BNWARIBE~Heh. I suppose that it does.~
== BSIRINE~Well then, thank you, friend.~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("NWSkieAribeth","GLOBAL",0)~THEN BSKIE Skie1
...
== BSKIE~I'm bored, wanna go shopping?~
== BNWARIBE~Wha.... You disturbed me to ask if I wanted to go shopping with you?~
== BSKIE~Well....yeah! It's not a problem, right?~
== BNWARIBE~Why ask me?~
== BSKIE~Everyone else is always so busy or like, "Not now Skie, I have no time for such frivolities.", or stuff like that.~
== BNWARIBE~And you've determined that I'm also not occupied?~
== BSKIE~Ummm...it's not that.~
== BNWARIBE~What exactly is it then?~
== BSKIE~I was just....kinda...hoping that we could...be friends.~
== BNWARIBE~.......~
== BSKIE~What? Why are you looking at me like that? Do I have something in my teeth?~
...
== BSKIE~Well, we're kinda the same, you and me.~
== BNWARIBE~In what way? In my mind we couldn't be more different.~
== BSKIE~It's like this. Yeah, you may have turned your back on your old life, but here you are, starting over with <CHARNAME> and the rest of us.~
== BSKIE~Me, I was murdered and now I'm back. We both have gotten a second chance at life. I for one want to make the most out of each day. Don’t you?~
== BNWARIBE~I guess that I have never looked at it in that way. Perhaps you have a point.~
== BSKIE~Of course I do! Now about that shopping trip! You are so pretty, we should definately get you some rouge for your lips....~
== BNWARIBE~*sigh*~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("NWSkieAribeth","GLOBAL",1)~THEN BSKIE Skie2
...
== BSKIE~Oh, don't be like that Bestie Number Two. You are only in second place because <CHARNAME> is my number one best friend.~
== BNWARIBE~I suppose that I can handle coming in behind <CHARNAME>.~
== BSKIE~Well, <CHARNAME> and I have a lot of history together, so don't take it personally.~
...
== BSKIE~No, no, no. Nothing like that.~
== BNWARIBE~We're not going shopping for clothing either!~
== BSKIE~No, it's not that. Although, I still think that you should dress in a manner that shows off your figure more.~
== BNWARIBE~That Calishite outfit that you picked out for me was practically see through in certain places!!~
== BSKIE~But you have to admit that it would have looked great on you, right!~
...
== BSKIE~Disagree, but we are getting off topic.~
== BNWARIBE~Yes, what exactly was supposed to be the topic of this conversation?~
== BSKIE~Oh, right. It was....ummm..... drat! I forgot.~
== BNWARIBE~Could it perhaps pertain to that flier in your hand?~
== BSKIE~Oh! Yes, that's right! There is a pastry shop that just opened and I thought that we could go?~
== BNWARIBE~Or perhaps we could do something more productive, such as running some combat drills?~
== BSKIE~There will be plenty of time for that later, but flaky, creme filled happiness waits for no one. Let's go!~
== BNWARIBE~*sigh*~
EXIT
...
== BVALYG~Anything that you want to talk about?~
...
== BVALYG~Life does have a way of interfering with plans for the future.~
...
== BVALYG~I'd be lying if I said that there wasn't. However, there has been too much tragedy. It's no longer worth the risk.~
== BVALYG~I've made peace with my choice by telling myself that it is to prevent the possibility of future pain or suffering.~
== BVALYG~You on the other hand, have no such curse hanging over you. My advice is to not despair. You still have time, and more importantly, hope.~
== BNWARIBE~Thank you Valygar. Your words provide more comfort than you know.~
== BVALYG~My pleasure. Come now, let's speak of more pleasant things.~
EXIT
...
== BVALYG~I was happy to be of help.~
...
== BVALYG~If I'm able, I'll do what I can.~
...
== BVALYG~I doubt that I will change my mind. But I will consider what you have said.~
...
CombatCounter(0)
!See([ENEMY])
Global("NWCoranAribeth","GLOBAL",0)~THEN BCORAN Coran1
~My lady, have I told you how ravishing you look today?~
DO~SetGlobal("NWCoranAribeth","GLOBAL",1)~
== BNWARIBE~Not since this morning.~
== BCORAN~Ahhhh only twice today then, I must rectify this.~
== BNWARIBE~Just stop!~
== BCORAN~My Lady?~
== BNWARIBE~I am NOT your Lady! I am not Lady Aribeth! I am not interested in your attentions, I find them trying!~
== BCORAN~This means that I have simply not been successful in expressing my feelings for you?~
== BNWARIBE~No, you've been more than successful, I am simply not interested.~
== BCORAN~Not yet, you mean?~
== BNWARIBE~*sigh*~
== BCORAN~~Your beauty shines like silver, tempered by loss, not broken but brightened by the cruelties of fate, my lady.~
== BNWARIBE~Your words are wasted upon me.~
== BCORAN~Give me but a chance and I will brighten those downcast eyes, I will quicken those heavy steps!~
== BNWARIBE~Why do you constantly torment me?~
== BCORAN~A lady so lovely should know joy, not sorrow! If you would but allow me to demonstrate, I am well versed in the myraid ways to a woman's heart!~
...
== BCORAN~A rose within your pack. Surely that is the noble gesture of a man seeking to express his feelings of devotion.~
== BCORAN~Why would you think that it was me?~
== BCORAN~Unless of course your heart was touched by this act of love?~
== BCORAN~Should that be the case, I could, possibly, be persuaded to reveal the identity of the charming rogue who placed it there. *wink*~
...
== BCORAN~Ummm... please forgive my trespass. I meant no harm. Perhaps I overstepped.~
== BNWARIBE~Indeed!~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("NWSharteelAribeth","GLOBAL",0)~THEN BSHARTE Sharteel1
~You fought well during our last battle.~
DO~SetGlobal("NWSharteelAribeth","GLOBAL",1)~
== BNWARIBE~Thank you? You also fought well.~
== BSHARTE~It is good to finally have a capable woman, such as yourself, at my side.~
== BNWARIBE~Ahh yes, that's right. You hold men in contempt, don't you.~
== BSHARTE~I have never once found a man worthy of my respect. Bedroom recreation and manual labor. That's all that they are good for!~
== BNWARIBE~Yet you travel and adventure with men?~
== BSHARTE~A farmer uses oxen to plow fields. A caravan uses horses to pull wagons.~
== BSHARTE~One can make use of a beast of burden without acknowledging them as an equal.~
== BNWARIBE~Don't you ever yearn for companionship? Something deeper than just a few nights of pleasure under the sheets?~
== BSHARTE~Hah! As if I'd ever let myself become some man's property in that way.~
== BNWARIBE~I see. You truly do not understand.~
== BSHARTE~What don't I understand?~
...
CombatCounter(0)
!See([ENEMY])
Global("NWSharteelAribeth","GLOBAL",1)~THEN BSHARTE Sharteel2
~I thought that you were someone I could respect!~
DO~SetGlobal("NWSharteelAribeth","GLOBAL",2)~
== BNWARIBE~What?!?~
== BSHARTE~I thought you a warrior, like myself, but I see now that I was wrong.~
== BNWARIBE~Yes, Shar-teel, you are wrong. You are no warrior.~
== BSHARTE~How dare you insult me like that!!~
...
== BSHARTE~I seek to test myself in battle!~
...
== BSHARTE~Better to be alone than be with someone who makes you weak!~
...
CombatCounter(0)
!See([ENEMY])
Global("NWTiaxAribeth","GLOBAL",0)~THEN BTIAX Tiax1
...
== BTIAX~You forget yourself! It is not <CHARNAME> who allows me to remain, it is I who allows <CHARNAME> to travel in my company!~
== BNWARIBE~Of course. How could I forget.~
== BTIAX~The great Tiax saw you roll your eyes. Such mockery will be punished once Tiax takes his place as ruler of the world.~
== BNWARIBE~Are we truly so desperate for comrades that we must suffer your company, madman?~
== BTIAX~Silence! Tiax rules all!~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("NWTiaxAribeth","GLOBAL",1)~THEN BTIAX Tiax2
...
== BTIAX~How dare you! Guards! Deal with this disrespectful wench! I... OUCH!~
== BNWARIBE~Do you want another one!~
== BTIAX~How dare you strike Tiax the Magnific...... OUCH!~
== BNWARIBE~Had enough yet?~
== BTIAX~What! Why do you continue to strike me? This will not.... OUCH!!~
== BNWARIBE~Well?~
== BTIAX~Ummm... I....err. Ahem. Being a merciful overlord, The Great Tiax will forgive your transgression.~
== BTIAX~Now, if you excuse me, I am urgently needed.... um... over there.~
EXIT
...
OR(6)
   ...
   AreaCheck("AR0900")
   AreaCheck("AR1000")
Global("NWAloraAribeth","GLOBAL",0)~THEN BALORA Alora1
...
== BALORA~Bleh. But look how fat that one is over there!~
== BNWARIBE~Put these larcenous thoughts away. They will only result in trouble, not just for you, but for the group.~
== BALORA~Ok. Ok. How about this? Pay me from your own money then. Four hundred gold, and I promise I won't steal anything.~
...
CombatCounter(0)
!See([ENEMY])
Global("NWAloraAribeth","GLOBAL",1)~THEN BALORA Alora2
...
== BALORA~Ok. I think that I'm missing something here.~
...
== BALORA~Don't worry, I'm too good to be caught.~
...
CombatCounter(0)
!See([ENEMY])
Global("NWXanAribeth","GLOBAL",0)~THEN BXAN Xan1
~My feet hurt from all this walking. Soon, I'll be permanently crippled.~
DO~SetGlobal("NWXanAribeth","GLOBAL",1)~
== BNWARIBE~Are... you going to be all right?~
== BXAN~Everything just gets worse, and there seems to be no final victory.~
== BXAN~Even if by some incredible chance we win, sickness or some horrible thing will strike us down eventually anyway. What's the point?~
...
== BXAN~But it all just seems so hopeless.~
...
== BXAN~But, how do I handle the feelings of despair?~
...
== BXAN~True. Things could always be even worse.~
...
CombatCounter(0)
!See([ENEMY])
Global("NWXanAribeth","GLOBAL",1)~THEN BXAN Xan2
...
== BXAN~I think my moonblade isn't glowing as brightly as yesterday.~
== BXAN~It's probably going to forsake me soon, isn't it? It's all so hopeless and worthless. Why do we even try?~
...
== BXAN~I... thank you. Things suddenly seem less bleak, though it will probably not last.~
EXIT
...
== BBRANWE~Aye. The Southern lands have their charms, but nothing compares to the cold beauty of the North. But you are from the North too, do you miss it?~
...
== BBRANWE~While I do bear resentment toward those who would not accept me, the place is not it's people.~
== BBRANWE~I can still hold the good memories of home apart from the bad experiences.~
...
== BBRANWE~Forgive me Aribeth. For I do not understand your question? Why would I not?~
...
== BBRANWE~..... I... find myself reluctant to answer.~
== BNWARIBE~I'm sorry. I had to right to ask.~
== BBRANWE~No, it's ok. I'd like to say that it is about forcing them to admit that their perception of the faith is wrong.~
== BBRANWE~That I wanted to drag them into the modern age and a new way of thinking.~
== BNWARIBE~But that isn't all?~
== BBRANWE~But that is only part of the answer. In truth, I also want them to acknowledge me.~
== BBRANWE~I needed them to do so. So as to quiet the voice within my own head that tells me that I am unworthy.~
== BNWARIBE~Why would yo think that?~
== BBRANWE~Because. I should be dead!~
== BNWARIBE~Dead?~
== BBRANWE~Specifically, I should still be a statue, standing in a field on the outskirts of Nashkel.~
== BBRANWE~I'd be, at best, a curiosity. At worst, an afterthought and a pigeon droppings collector.~
== BNWARIBE~Hmmph! Excuse me. I didn't mean to laugh.~
== BBRANWE~It's ok. I can see the humor in the situation as well. I would still be in that field had not <CHARNAME> freed me from that fate.~
== BBRANWE~I was given a second chance through nothing but dumb luck. I played no part whatsoever in my own salvation.~
== BBRANWE~Were it not for <CHARNAME>'s kindness, my tale would be ended.~
== BBRANWE~I couldn't even save myself, what right have I to consider myself a priest of Tempus?~
...
== BKIVAN~I am unsure as what to make of you.~
== BNWARIBE~What do you mean?~
== BKIVAN~Upon first meeting, I'd taken you to be a disciple of vengeance, such as myself. However, I am not now so sure.~
== BNWARIBE~I am NOT a disciple of revenge!~
== BKIVAN~Are you not? In your youth, did you not destroy a tribe of orcs to avenge your slain family.~
== BKIVAN~Did you not lead a crusade against Neverwinter in response to the execution of your lover?~
== BNWARIBE~I..... I have moved on from that.~
== BKIVAN~If you say as such.~
EXIT
...
// 1.
// --
CHAIN IF~InParty("Helga")
Detect("Helga")
!StateCheck("Helga",CD_STATE_NOTVALID)
!StateCheck("NWARIBET",CD_STATE_NOTVALID)
CombatCounter(0)
!See([ENEMY])
...
== BHELGA~Aye! I got me some ankle biters, grown now, though.~
== BNWARIBE~Do you miss them, when you travel?~
== BHELGA~Aye. But that be not what yer askin' isn't it?~
== BNWARIBE~What do you mean?~
== BHELGA~What you want to know is how I, a mother, could be out adventurin' and riskin' my life instead of bein' home with the wee ones?~
== BNWARIBE~Well, yes.~
== BHELGA~I could tell ye some tale about how I'm out here making the world a safer place for them.~
== BHELGA~Or it could be that I need to earn a livin' and provide for them and adventurin' is the most lucrative job that there be.~
== BHELGA~Perhaps I'm seekin' someone who wronged me and my kin, seekin justice for some crime committed. Would any of those answers satisfy?~
== BNWARIBE~Perhaps.~
== BHELGA~But the whole truth of the matter is just that I could never stay still for long.~
== BHELGA~Sittin at home was never the life for me and were I to try it, I'd be a shell of the woman that I am.~
== BNWARIBE~I see. I don't believe that I could ever leave my child as you have.~
== BHELGA~I be glad to hear it. I do miss the younguns', but were I to try and stay, I'd lose meself.~
== BHELGA~Ye have the makings of bein' a good mother someday.~
== BHELGA~When that day comes, I do hope that ye'll be able to settle into a quiet life and enjoy your family without any regrets.~
== BNWARIBE~Thank you?~
== BHELGA~Think nuthin' of it, lass.~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("NWHelgaAribeth","GLOBAL",1)~THEN BHELGA Helga2
~Aribeth, lass?~
DO~SetGlobal("NWHelgaAribeth","GLOBAL",2)~
== BNWARIBE~Yes Helga, something I can do for you?~
== BHELGA~Before ye' took service with Neverwinter, did ye' adventure as part of a group?~
...
== BHELGA~I thought as much.~
== BNWARIBE~Why do you ask.~
== BHELGA~Just curious. It's one thing to work with others, but to be a part of an adventuring party, that is a unique experience.~
== BHELGA~To fight, travel and live with others, to a point where they know you as well as you know yourself is a special type of bond.~
== BNWARIBE~What did you mean by your comment before?~
== BHELGA~When one is a part of an adnventurin' company long enough, you can tell by the way the carry themselves. You don't have that look yet.~
== BNWARIBE~Is that a problem?~
== BHELGA~No, it just means that you haven't yet learned to place your life in the hands of others with complete trust.~
== BNWARIBE~Do you have a point to this lecture?~
== BHELGA~Just this. You may trust <CHARNAME>, but do you trust anyone else? If not, then no one will ever trust you.~
EXIT
...
CHAIN IF~InParty("NWARIBET")
Detect("NWARIBET")
!StateCheck("Recorder",CD_STATE_NOTVALID)
!StateCheck("NWARIBET",CD_STATE_NOTVALID)
CombatCounter(0)
!See([ENEMY])
Global("NWRecorderAribeth","GLOBAL",0)~THEN BRECORD Recorder1
~Aribeth, a moment of your time, if I may?~
DO~SetGlobal("NWRecorderAribeth","GLOBAL",1)~
== BNWARIBE~What can I do for you?~
== BRECORD~I'd like to record your story.~
== BNWARIBE~What!~
== BRECORD~I'd like to chronicle the events of your life, from your origin to the time that you joined the party of <CHARNAME>.~
== BNWARIBE~Why would you do this?~
== BRECORD~Because everyone has a story and every story deserves to be told.~
== BRECORD~The events of Neverwinter are easily recounted, but I was hoping that you would tell me of your past?~
== BRECORD~Everything from your early days, up through the events that brought you into the service of Neverwinter.~
...
== BRECORD~Very well, but remember, this is your story, not mine.~
EXIT

// 2.
// --
CHAIN IF~InParty("Recorder")
Detect("Recorder")
!StateCheck("Recorder",CD_STATE_NOTVALID)
!StateCheck("NWARIBET",CD_STATE_NOTVALID)
CombatCounter(0)
...
== BRECORD~Thank you for your words.~
== BNWARIBE~Yes, well. I too lost my family, not in the same manner as you, but I can relate to some of your hardship.~
== BRECORD~I understand, but may I ask if knowing about my history causes you to see my work in a new light?~
== BNWARIBE~New light?~
== BRECORD~Yes. A chronicle of ones life is not simply a story, but a testament, if you will.~
== BRECORD~It serves as a marker, a reminder that you were here and of your accomplishments. That you impacted lives and left your mark on the world in some way.~
...
== BRECORD~You wish to be forgotten?!?~
...
// 1.
// --
CHAIN IF~InParty("Emily")
Detect("Emily")
!StateCheck("Emily",CD_STATE_NOTVALID)
!StateCheck("NWARIBET",CD_STATE_NOTVALID)
CombatCounter(0)
!See([ENEMY])
...
== BEMILY~It's Emily, Aribeth. Only my father and retainers call me Emelia.~
== BNWARIBE~Very well, Emily.~
== BEMILY~Much better. What do you require?~
...
== BEMILY~To you it may seem as such, for me, it is merely something for which I've spent my life becoming accustomed. Regardless, things are as they are.~
== BEMILY~Brooding will do nothing, save give one wrinkles and I can't bear the thought of this pretty face being marred as such.~
== BNWARIBE~HA! I hope that you retain this sunny disposition.~
== BEMILY~As do I dear, Aribeth. As do I.~
EXIT
...
== BEMILY~My father told me to go and find myself. I read stories of great adventures as a child and have always been drawn to the romance of the life.~
== BNWARIBE~I see, and have you found yourself?~
== BEMILY~I'm afraid that my search for Emily is still ongoing. But I am having a lot of fun while ding so.~
...
== BEMILY~Often.~
== BNWARIBE~But?~
== BEMILY~But then I remember my duties. I weigh the happiness that I would find by pursuing my dreams versus the guilt.~
== BEMILY~How would feel about the suffering and disappointment that my desertion would cause?~
== BEMILY~Considering that, I find that I am no longer so happy after all.~
== BNWARIBE~So, have you decided what you will ultimately do?~
== BEMILY~For the moment, continue my quest to find the true Emily, make some good friends and have fun along the way.~
== BNWARIBE~Well, I must admit that that doesn't sound like a bad plan.~
== BEMILY~I thought that you might agree, friend Aribeth.~
EXIT
...
// 1.
// --
CHAIN IF~InParty("Kale")
Detect("Kale")
!StateCheck("Kale",CD_STATE_NOTVALID)
!StateCheck("NWARIBET",CD_STATE_NOTVALID)
CombatCounter(0)
!See([ENEMY])
...
== BKALE~Hmmm? Oh, well thank you, but you need'nt be. I'm not.~
== BNWARIBE~You don't miss him?.~
== BKALE~I never knew him, it's hard to miss someone who was never there.~
== BNWARIBE~You don't regret never having known him while growing up?~
== BKALE~Never really thought about it. He wasn't around and being angry or sad about it wouldn't change anything, would it?~
== BNWARIBE~I suppose not.~
== BKALE~Exactly. So what would be the point?~
== BNWARIBE~I guess that makes sense.~
== BKALE~Of course it does. Halfling wisdom will never steer you wrong.~
== BNWARIBE~HA!~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("NWKaleAribeth","GLOBAL",1)~THEN BKALE Kale2
~Hrmmph!~
DO~SetGlobal("NWKaleAribeth","GLOBAL",2)~
== BNWARIBE~Something troubles you, Kale?~
== BKALE~My father's journal.~
== BNWARIBE~Care to explain?~
== BKALE~I wish that I'd never let <CHARNAME> talk me into reading the blasted thing.~
...
== BKALE~Well, if that was the intent, it failed.~
== BNWARIBE~How so?~
== BKALE~Reading this gave me an insight into him. It was always obvious that he was a flawed individual.~ 
== BKALE~I had no idea just how flawed. I wish that I didn't know.~
== BNWARIBE~Is it really so bad?~
== BKALE~Yes. At least when he was a mystery, there were some things that I could imagine, but now.....~
== BNWARIBE~I wish that there was something that I could do.~
== BKALE~Ehh, no biggie. I'll complain for a few hours and then remember that I'm no better or worse off than before and I'll move on.~
== BNWARIBE~Once again, halfling wisdom does not disappoint.~
== BKALE~In realizing that, you show almost equal wisdom. ALMOST equal.~
...
CHAIN IF~InParty("NWARIBET")
Detect("NWARIBET")
!StateCheck("Vienxay",CD_STATE_NOTVALID)
!StateCheck("NWARIBET",CD_STATE_NOTVALID)
CombatCounter(0)
!See([ENEMY])
Global("NWVienxayAribeth","GLOBAL"0)~THEN BVIENXA Vienxay1
~Need you something?~
DO~SetGlobal("NWVienxayAribeth","GLOBAL",1)~
== BNWARIBE~No... I was simply curious and hoped that I might as a question of you?~
== BVIENXA~I have no interest in satisfying your curiosity.~
== BNWARIBE~I simply wanted to know what you may have done to ease the pain of your banishment?~
== BVIENXA~I'm positive that I just said that I had no interest in answering any of your questions.~
...
== BVIENXA~Ha! So you believe that I, a fellow exile will what? Feel sympathy for your plight?~
== BVIENXA~Do you expect us to forge a bond based upon our shared experience of being forced from our homeland?~
== BVIENXA~Trouble me not with your irritating inquiries.~
== BNWARIBE~Aribeth: Very well.~
EXIT

// 2.
// --
CHAIN IF~InParty("Vienxay")
Detect("Vienxay")
!StateCheck("Vienxay",CD_STATE_NOTVALID)
!StateCheck("NWARIBET",CD_STATE_NOTVALID)
CombatCounter(0)
...
== BVIENXA~Again you trouble me!~
== BNWARIBE~I intend no trouble, I simply noticed that you seemed more morose than usual and I asked if you are ok.~
== BVIENXA~I do not..... *Sigh*. I apologize for my outburst, I am fine. Do not trouble yourself with my concerns.~
== BNWARIBE~It's no trouble. Are you thinking of your homeland once again?~
== BVIENXA~Once again? That would imply that I cease thinking of it.~
== BNWARIBE~Do you wish to talk?~
== BVIENXA~No, I truly don't. Speaking of Evermeet only brings painful memories and provides no comfort.~
== BNWARIBE~Indeed? I have found that speaking of things such as this can prove cathartic.~
== BVIENXA~That is because you have made a peace... of sorts with your banishment, yes?~
== BVIENXA~Tell me. Given your actions, do you consider your exile to be just? Have you accepted this to be your fate?~
== BNWARIBE~I suppose that the answer to your questions would be, yes. Mostly.~
== BVIENXA~That is where the difference between us lies. I would have answered no to all of them.~
== BVIENXA~So you see, even just speaking of this is picking at open wounds.~
== BNWARIBE~I see. Then I'll not add anymore salt to them. However, I'll be here if you wish to speak further.~
== BVIENXA~I wouldn't count on it.~
EXIT
